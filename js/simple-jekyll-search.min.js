...
(function (window) {
  ...
  var options = {
    ...
    searchResultTemplate: '<li class="docs-search--results"><a href="{url}" class="docs-search--results_item" title="{title}">{title}</a></li>',
    templateMiddleware: Function.prototype,
    sortMiddleware: function () {
      return 0
    },
    noResultsText: '<li class="docs-search--results">No results found</li>',
    limit: 100,
    fuzzy: false,
    exclude: []
  }
