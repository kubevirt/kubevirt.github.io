...
* Deploy KubeVirt using the [official documentation](https://kubevirt.io/user-guide/docs/latest/administration/intro.html). For this blog post the version *0.11.0* has been used.
* Metrics:
